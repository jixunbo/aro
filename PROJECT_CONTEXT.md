...
- The project has four targets: `traceon` (`com.xunbo.traceon`), embedded `Companio Watch App` (`com.xunbo.traceon.watchkitapp`, companion identifier `com.xunbo.traceon`), embedded `Companio Watch Widget Extension` (`com.xunbo.traceon.watchkitapp.widget`), and `traceonTests`. The Watch App and Widget Extension share the Watch App Group `group.com.xunbo.traceon.watch`; the iOS host does not need that group.
