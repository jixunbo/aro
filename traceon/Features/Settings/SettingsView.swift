...
struct SettingsView: View {
    ...
    @State private var exportFilename = "Companio.gpx"
    ...
    private var aboutSection: some View {
        Section("关于") {
            LabeledContent("产品", value: "Companio")
    ...
    private func prepareExport(asGPX: Bool) {
        ...
        Task.detached(priority: .userInitiated) {
            ...
            let name = "Companio \(Date.now.formatted(.iso8601.year().month().day()))"
            ...
            await MainActor.run {
                ...
                exportFilename = asGPX ? "Companio.gpx" : "Companio.geojson"
