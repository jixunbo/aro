...
- Complete the real-device/two-device CloudKit checks in `TESTING.md`: provisioning for `iCloud.com.xunbo.aro`, Push Notifications and Remote notifications, initial upload, silent-push pull, offline/local-first recording, duplicate reconciliation, disable/re-enable, global delete propagation, account changes, and Core Location cold-launch isolation.
