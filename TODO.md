...
- Complete the paired iPhone/Apple Watch checks in `TESTING.md`: install/upgrade, application-context delivery, explicit refresh, cached fallback, Shortcut execution, watchOS background refresh, Core Location relaunch isolation, and before/after energy comparison.
