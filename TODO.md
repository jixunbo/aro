...
- [ ] Watch 真机验证 Track complication：iPhone 当日路线变化后通过 complication user-info delivery 更新，不要求手动打开 Watch App。
- [ ] Watch 真机验证 Battery complication：>50% 为绿色、21–50% 为橙色、≤20% 为红色；记录 `WKInterfaceDevice.batteryLevel` 在实际 watchOS/硬件上的报告粒度。
- [ ] Watch App/Widget 真机安装与后台刷新验证。
